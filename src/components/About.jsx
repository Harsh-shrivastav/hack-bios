          ...
          <div className="relative bg-[#050a05]/85 backdrop-blur-xl border border-[#00ff41]/10 rounded-xl p-8 md:p-16 max-w-4xl w-full">
            ...
            <div className="relative">
              <div className="text-center mb-12">
                <h2
                  className="text-4xl md:text-5xl lg:text-6xl font-mono font-bold glitch uppercase tracking-tighter"
                  data-text="/ ABOUT"
                >
              ...
              {/* Normal static text */}
              <p className="max-w-3xl mx-auto text-center text-lg md:text-xl font-normal text-gray-300 leading-relaxed font-sans opacity-90">
                HackBIOS is Shri Shankaracharya Technical Campus's flagship
                hackathon — a hands-on sprint where ideas boot into reality.
                Now in its 3rd edition, it brings developers, designers, and
                innovators together to build, break, and ship across open
                innovation tracks spanning a range of domains and problem
                statements. Our last edition saw 70+ teams compete head-to-head
                for prizes topped by a ₹50,000 first prize, making HackBIOS a
                hub for innovation, collaboration, and talent development —
                built by students, for students, and proudly hosted by SSTC
                Bhilai.
              </p>
            </div>
          </div>
