      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 flex flex-col items-center gap-6">
        {banners.map((partner) => (
          ...
          >
            ...
            <div className="relative flex items-center justify-between gap-6 bg-[#050a05]/90 backdrop-blur-xl rounded-2xl px-8 py-8 border border-white/5">
              <div className="flex items-center gap-6">
                ...
                <span className="font-mono text-base md:text-lg uppercase tracking-[0.2em] text-gray-300 font-semibold">{partner.label}</span>
              </div>
              <span
