...
const StatBox = ({ target, label, prefix = "", suffix = "" }) => {
  ...
  return (
    <div ref={boxRef} className="flex flex-col items-center justify-center p-6 border-r-0 md:border-r border-[#00ff41]/20 md:last:border-r-0 min-w-[140px] sm:min-w-[200px]">
