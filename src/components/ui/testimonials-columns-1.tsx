              ...
              {props.testimonials.map(({ text, name, role }, i) => (
                <div className="p-8 rounded-3xl border border-[#00ff41]/20 shadow-lg shadow-[#00ff41]/5 max-w-xs w-full bg-[#0a0f0a] text-gray-300 relative overflow-hidden group" key={i}>
                  ...
                  <div className="flex items-center gap-3 mt-6 relative z-10">
                    <div className="h-10 w-10 rounded-full border border-[#00ff41]/40 bg-[#00ff41]/10 flex items-center justify-center flex-shrink-0">
                      <span className="text-[#00ff41] font-mono font-bold text-sm">{name[0]}</span>
                    </div>
